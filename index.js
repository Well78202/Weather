...
function displayCurrent(a, t) {
  if (null != t) {
    ...
    let n = `<div class="today forecast">    <div class="forecast-header"  id="today">    <div class="day">${
      days[e.getDay()]
    }</div>    <div class=" date">${
      e.getDate() + monthNames[e.getMonth()]
    }</div>    </div> \x3c!-- .forecast-header --\x3e    <div class="forecast-content" id="current">    <div class="location">${
      a.name
      ...
      t.condition.text
    }</div>    <span><img src="images/icon-umberella.png" alt="">20%</span><span><img src="images/icon-wind.png" alt="">18km/h</span>\n\t\t\t\t\t\t\t\t<span><img src="images/icon-compass.png" alt="">East</span>    </div>\n</div>`;
...
function displayAnother(a) {
  ...
  for (let e = 1; e < a.length; e++)
    ...
    }</div>        </div> \x3c!-- .forecast-header --\x3e        <div class="forecast-content">            <div class="forecast-icon">                <img src="https:${
